...
class AdminEditProductComponent extends Component
{
    ...
    public function mount($product_slug)
    {
        ...
        foreach($attribute_arr as $attr_arr)
        {
            $allAttributeValue = AttributeValue::where('product_id',$product->id)->where('product_attribute_id',$attr_arr)->get()->pluck('value');
            $valueString = '';
    ...
    public function render()
    {
        ...
        return view('livewire.admin.admin-edit-product-component',['categories'=>$categories,'product_attributes'=>$product_attributes])->layout('layouts.base');
    }
}
