                    ...
                    <div class="login-form form-item form-stl">
                        ...
                        <form name="frm-login" method="POST" action="{{route('password.update')}}"> 
							...
							<fieldset class="wrap-input item-width-in-half ">
								<label for="password_confimartion">Confirm Password *</label>
								<input type="password" id="password_confimartion" name="password-confirmation" placeholder="Confirm Password" required autocomplete="new-password">
							</fieldset>
