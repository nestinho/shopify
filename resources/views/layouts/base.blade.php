...
<head>
	...
	<!-- Select2 CDN link found on www.select2.org-->
	<link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
	<!-- Bootstrap datetime picker 4 CDN CSS -->
				...
				<div class="topbar-menu-area">
					<div class="container">
						<div class="topbar-menu left-menu">
							<ul>
								<li class="menu-item" >
									<a title="Hotline: +255 (0) 755 800 888" href="#" ><span class="icon label-before fa fa-mobile"></span>Hotline: +255 (0) 755 800 888</a>
								</li>
							</ul>
						</div>
									...
									@auth
										...
										<li class="menu-item menu-item-has-children parent" >
											...
											<ul class="submenu curency" >
												...
												<li class="menu-item" >
													<a title="Manage sale setting" href="{{route('admin.sale')}}">Sale Settings</a>
												</li>
												<li class="menu-item" >
