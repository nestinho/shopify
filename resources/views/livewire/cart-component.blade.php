		...
		<div class="container">
			...
			<div class=" main-content-area">
					...
					<div class="wrap-iten-in-cart">
						...
						<ul class="products-cart">
							...
							<li class="pr-cart-item">
								...
								<div class="delete">
									<a href="#" class="btn btn-delete" title="" wire:click="destroy('{{$item->rowId}}')">
					...
					<div class="summary">
						<div class="order-summary">
							...
							@if(Session::has('coupon'))
								<p class="summary-info"><span class="title">Discount ({{ Session::get('coupon')['code'] }}) <a href="#" wire:click.prevent="removeCoupon"><i class="fa fa-trash text-danger"></i></a></span><b class="index">-${{number_format($discount,2)}}</b></p>
									...
									<div class="title-item">
										<form wire:submit.prevent="applyCouponCode">
											...
											<p class="row-in-form">
												...
												<input type="text" class="" name="coupon-code" wire:model="couponCode"/>
											</p>
											<button type="submit" class="btn btn-sm btn-success">Apply Coupon</button>
										</form>
									</div>
								@endif
						@endif
				...
				<div class="wrap-iten-in-cart">
					...
					<div class="alert alert-success">
						 <strong>Success.</strong>
               			 {{ Session::get('save_success_message')}}
           			</div>
					@endif
					...
					<ul class="products-cart">
						...
						<li class="pr-cart-item">
							...
							<div class="delete">
								<a href="#" class="btn btn-delete" title="" wire:click="deleteFromSaveForLater('{{$item->rowId}}')">
					...
					@else
						<p class="text-danger">No item saved for later</p>				
					@endif
				</div>
