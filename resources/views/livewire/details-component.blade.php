						...
						<div class="detail-info">
							<div class="product-rating">
                                ...
                                <a href="#" class="count-review">
									(
										{{ $product->orderItems->where('rstatus',1)->count() }} <!-- Counts the number of reviews -->
										<!-- Toggle between singular and pluralfor the word review -->
										@if($product->orderItems->where('rstatus',1)->count() <= 1 ) 
											review 
										@else 
											reviews
										@endif 
							...
							<div>
								@foreach($product->attributeValues->unique('product_attribute_id') as $av)
									<div class="row" style="margin-top: 20px" wire:model="satt.{{$av->productAttribute->name}}">
										<div class="col-xs-2">
											<p>{{$av->productAttribute->name}}</p>
										</div>
										<div class="col-xs-10">
											<select name="" id="" class="form-control" style="width: 200px;">
												@foreach($product->productAttribute->attributeValues->where('product_id',$product->id) as $pav)
											...
											<ol class="commentlist">
												<li class="comment byuser comment-author-admin bypostauthor even thread-even depth-1" id="li-comment-20">
													<div id="comment-20" class="comment_container"> 
														<img alt="" src="{{ asset('assets/images/profiles')}}" height="80" width="80">
