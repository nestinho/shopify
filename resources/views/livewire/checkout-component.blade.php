				...
				<form wire:submit.prevent="placeOrder" onsubmit="$('#processing').show()">
							...
							<div class="wrap-address-billing">
								...
								<div class="billing-address">
									...
									<p class="row-in-form">
										...
										<input type="text" name="add" value="" placeholder="Street address line 1" wire:model="line1">
										@error('line1') <span class="text-danger">{{$message}}</span> @enderror
									</p>
									<p class="row-in-form">
										<label for="add">Line 2:</label>
										<input type="text" name="add" value="" placeholder="Street address line 2" wire:model="line2">
									</p>
									<p class="row-in-form">
						...
						<div class="col-md-12">
							<div class="wrap-address-billing">
								...
								<div class="billing-address">
									<p class="row-in-form">
										<label for="fname">first name<span>*</span></label>
										<input type="text" name="fname" value="" placeholder="Your name" wire:model="shipping_firstname">
									...
									<p class="row-in-form">
										<label for="phone">Phone number<span>*</span></label>
										<input type="number" name="phone" value="" placeholder="10 digits format" wire:model="shipping_mobile">
										@error('shipping_mobile') <span class="text-danger">{{$message}}</span> @enderror
									</p>
									<p class="row-in-form">
										<label for="add">Line 1<span>*</span></label>
										<input type="text" name="add" value="" placeholder="Street at apartment number" wire:model="shipping_line1">
										@error('shipping_line1') <span class="text-danger">{{$message}}</span> @enderror
									</p>
									<p class="row-in-form">
										<label for="add">Line 2:</label>
										<input type="text" name="add" value="" placeholder="Street at apartment number" wire:model="shipping_line2">
									</p>
									<p class="row-in-form">
										<label for="country">Country<span>*</span></label>
										<input type="text" name="country" value="" placeholder="United States" wire:model="shipping_country">
										@error('shipping_country') <span class="text-danger">{{$message}}</span> @enderror
									</p>
									<p class="row-in-form">
										<label for="city">Province:<span>*</span></label>
										<input type="text" name="province" value="" placeholder="Province name" wire:model="shipping_province">
					...
					<div class="summary summary-checkout">
						<div class="summary-item payment-method">
							...
							@if($paymentmode == 'card')
							<p style="padding-bottom: 10px;">Enter Card Details</p>
							<div class="wrap-address-billing">
								...
								<p class="row-in-form">
									...
									<input type="text" name="card-number" value="" placeholder="Your Card Number" wire:model="card_number">
								...
								<p class="row-in-form">
									...
									<input type="password" name="cvc" placeholder="CVC" value=""  wire:model="cvc">
